...
const DEFAULT_HEADER = ["User-Agent:Godot Engine 2.0/ Panrun", "Accept:*/*"]
const EVENT_SOURCE_HEADER = ["User-Agent:Godot Engine 2.0/ Panrun", "Accept:text/event-stream"]

var http_url = preload("http_url.gd")
var http_request = preload("http_request.gd")
var event_source = preload("event_source.gd")
var thread_pool_task = preload("thread_pool_task.gd")
